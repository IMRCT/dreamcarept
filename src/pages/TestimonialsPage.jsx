...
const QUOTES = [
  { quote: 'I had nagging back pain for two years and tried everything. Three weeks with Dr. Ashkani and the difference is night and day. He found the actual cause instead of just chasing the pain.', name: 'Maya R.', role: 'Chronic low back pain', tone: 'mint' },
  ...
  { quote: 'Telehealth sessions while I was recovering at home with full evaluation, exercise progressions and check-ins. Honestly better than some in-person care I had before.', name: 'Sam P.', role: 'Telehealth client', tone: 'sun' },
